package com.net.download.util;

/**
 * Created by Frank on 2018/5/11.
 * email:406271809@qq.com
 */
...
//                .setDefaults(Notification.FLAG_ONLY_ALERT_ONCE|Notification.DEFAULT_VIBRATE | Notification.DEFAULT_SOUND)
//                .build();;
     }
     ...
     * @param context 上下文
     */
    public static void showNotification(Context context,int notiid,String title,String content) {
        Log.i(TAG, "showNotification: notiid "+notiid);
...
//        notification = builder.build();
    ...
    public static void changeNotificationText(Context context,int notiid,String title,String content)
    {
        Notification notification = new Notification.Builder(context)
                /**设置通知左边的大图标**/
                .setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.drawable.notify_icon))
...
//                .setContentIntent(PendingIntent.getActivity(context, 1, new Intent(context, MainActivity.class), PendingIntent.FLAG_CANCEL_CURRENT))
    ...
    public static void updateNotificationProcess(Context context,int notiid,String title,String content)
    {

        Log.i(TAG, "updateNotificationProcess: ");
        Notification notification = new Notification.Builder(context)
                /**设置通知左边的大图标**/
                .setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.drawable.notify_icon))
                /**设置通知右边的小图标**/
                ...
                .setOngoing(false)
                /**向通知添加声音、闪灯和振动效果的最简单、最一致的方式是使用当前的用户默认设置，使用defaults属性，可以组合：**/
//                .setDefaults(Notification.FLAG_ONLY_ALERT_ONCE| Notification.DEFAULT_SOUND|Notification.DEFAULT_VIBRATE)
//                .setDefaults(Notification.DEFAULT_VIBRATE | Notification.DEFAULT_SOUND)
//                .setContentIntent(PendingIntent.getActivity(context, 1, new Intent(context, MainActivity.class), PendingIntent.FLAG_CANCEL_CURRENT))
                .build();
...
//        notification = builder.build();
    ...
    public static void showNotificationProgress(Context context) {
        ...
        builderProgress.setSmallIcon(R.drawable.notify_icon);
...
//        }, 0);
     ...
     * 移除通知
     */
    public static void removeNotification(Context context,int notiid) {
